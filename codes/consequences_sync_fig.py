...
# Last modified: Wed Dec 04, 2019  01:56pm
...
if __name__ == "__main__":
    ...
    ax1.set_xlabel(r"Time $t$", fontsize=axlabfs, labelpad=5.)
    ax1.set_ylabel(r"R{\"o}ssler $x$",
                   fontsize=axlabfs, labelpad=5.)
    ax1.set_xlim(t[0], t[-1])
    ax2.set_xlabel(r"$x$-component of system 1 $x_1$",
                   fontsize=axlabfs, labelpad=5.)
    ax2.set_ylabel(r"$x$-component of system 2 $x_2$",
                   fontsize=axlabfs, labelpad=5.)
