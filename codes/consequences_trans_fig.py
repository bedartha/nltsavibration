...
# Last modified: Wed Dec 04, 2019  01:55pm
...
if __name__ == "__main__":
    ...
    ax1.set_ylabel(r"R{\"o}ssler $x$", fontsize=axlabfs, labelpad=5.)
    ...
    for ax in [ax2, ax3]:
        ...
        ax.zaxis.gridlines.set_alpha(0.5)
        ax.set_xlabel(r"R{\"o}ssler $x$",
                      fontsize=axlabfs, labelpad=5.)
        ax.set_ylabel(r"R{\"o}ssler $y$",
                      fontsize=axlabfs, labelpad=5.)
        ax.set_zlabel(r"R{\"o}ssler $z$",
                      fontsize=axlabfs, labelpad=5.)
