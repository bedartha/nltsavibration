...
# Last modified: Wed Dec 04, 2019  01:59pm
...
if __name__ == "__main__":
    ...
    ax1.zaxis.gridlines.set_alpha(0.5)
    ax1.set_xlabel(r"R{\"o}ssler $x$",
                   fontsize=axlabfs, labelpad=5.)
    ax1.set_ylabel(r"R{\"o}ssler $y$",
                   fontsize=axlabfs, labelpad=5.)
    ax1.set_zlabel(r"R{\"o}ssler $z$",
                   fontsize=axlabfs, labelpad=5.)
    ## Henon map
    ax2.set_xlabel(r"H{\'e}non $x_t$", fontsize=axlabfs, labelpad=5.)
    ax2.set_ylabel(r"H{\'e}non $y_t$", fontsize=axlabfs, labelpad=5.)
