...
if __name__ == "__main__":
    ...
    phi1 = np.unwrap(np.angle(hilbert(x1[::5])))
    phi2 = np.unwrap(np.angle(hilbert(x2[::5])))
    ...
    ax2.set_xlabel(r"$x_1$", fontsize=axlabfs, labelpad=5.)
    ax2.set_ylabel(r"$x_2$", fontsize=axlabfs, labelpad=5.)
    ax2.set_xticks(np.arange(-10., 10.1, 5))
    ax2.set_yticks(np.arange(-10., 10.1, 5))
    ax2.set_xlim(-15., 15.)
    ax2.set_ylim(-15., 15.)
    ax3.set_xlabel(r"$\phi_1$", fontsize=axlabfs, labelpad=5.)
    ax3.set_ylabel(r"$\phi_2$", fontsize=axlabfs, labelpad=5.)
