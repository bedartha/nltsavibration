...
# Last modified: Wed Dec 04, 2019  01:58pm
...
if __name__ == "__main__":
    ...
    ax1.set_xlabel("Time $t$", fontsize=axlabfs, labelpad=5.)
    ...
    ax3.zaxis.gridlines.set_alpha(0.5)
    ax3.set_xlabel(r"X-component $x$", fontsize=axlabfs, labelpad=5.)
    ax3.set_ylabel(r"Y-component $y$", fontsize=axlabfs, labelpad=5.)
    ax3.set_zlabel(r"Z-component $z$", fontsize=axlabfs, labelpad=5.)
