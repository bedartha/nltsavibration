...
# Last modified: Wed Dec 04, 2019  02:00pm
...
if __name__ == "__main__":
    ...
    ax1.set_xlabel(r"R{\"o}ssler control parameter $a$",
                   fontsize=axlabfs, labelpad=5.)
    ax1.set_ylabel(r"R{\"o}ssler $y$", fontsize=axlabfs, labelpad=5.)
    ...
    ax2.set_xlabel(r"H{\'e}non control parameter $a$",
                   fontsize=axlabfs, labelpad=5.)
    ax2.set_ylabel(r"He{\'e}non $x_t$", fontsize=axlabfs, labelpad=5.)
